...
class MoveProjectCommand {
    ...
    async execute(httpEvent) {
        ...
        let newPath = JSON.parse(httpEvent.body).path;
        
        if (!projectId) {
            return new Response(404, null);
        } else if (!newPath) {
            return new Response(422, null, 'Missing path');
        }
    ...
    async saveToEventStore(payload) {
        ...
        let newEvent = eventFactory.getProjectMovedEvent(payload);
...
module.exports = MoveProjectCommand;